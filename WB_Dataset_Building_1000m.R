...
#1000m (1km) grid cells to match dmsp for robustness check
wb_cells<-read.csv("Data/road_grid_1000_extracts.csv",na.strings=c("","NA"))
...
muni_shp <- st_read("Data/cells_localities_join_1000m.shp")
